...
export default function Home() {
  ...
  const projects = [
    {
      ...
      "description": "Aplicación android que le enseña a niños los animales, colores y números en 3 idiomas: inglés, portugués y español.",
  ...
  const experiencies = [
    {
      "title": "SiChef Catering",
      "from": "Enero 2024",
      "to": "Marzo 2024",
      "description": "Mozo en eventos de la empresa",
      "imagePath": "/foto/propia_grande.png"
    },
    {
      "title": "Consultor TI | Netnix S.A.",
      "from": "Marzo 2024",
      "to": "",
      "description": "Optimización y gestión de servicios de TI, asegurando eficiencia, automatización y cumplimiento de estándares ITIL v4.",
      ...
      <header className="w-full backdrop-blur-sm flex items-center justify-between p-4 mt-2 text-white">
        ...
        <div className="w-1/2 flex justify-end gap-2">
          ...
          >
            <Image
              key={theme}
              src={theme === 'black' ? IMAGE_LIGHT_THEME_PATH : IMAGE_DARK_THEME_PATH}
